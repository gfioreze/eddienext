    ...
    <header id="home">
      <nav className="navbar">
        ...
        <ul className="navbar-list">
          <li><a href="#my-work" className="navbar__link">My work</a></li>
          <li><a href="#about-me" className="navbar__link">About me</a></li>
          <li><a href="#get-in-touch" className="navbar__link">Get in touch</a></li>
        </ul>
